...
import com.access.control.config.security.JwtTokenUtil;
...
public class JwtAuthenticationController {
    private static Logger LOGGER =LoggerFactory.getLogger(JwtAuthenticationController.class.getName());
...
LOGGER.info("Authenticating Admin"+authenticationRequest.getUsername());
